...
const Default = () => {
    const {getUrlLinkToBeRedirectedTo,campaignName} = useGlobalStoreContext()
            ...
            >
                <div className="flex flex-col justify-center items-center gap-5">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        />
                        <div>
                            <p className="font-normal text-gray-500">You just experienced</p>
                    ...
                    <a
                        ...
                        target="_blank"
                    >
                        <button className="text-white text-sm bg-black rounded-[28px] w-[233px] h-[56px] shadow-lg shadow-black mt-10">
