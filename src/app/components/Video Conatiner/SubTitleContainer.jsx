...
const SubTitleContainer = ({subtitile_data}) => {
    ...
    const {target_video_element,website_scroll_config} =useGlobalStoreContext()
...
useEffect(()=>{
    integrateSubtitle()
 return ()=>{
    const personaliz_player_video_track_previous=document.getElementById('personaliz_video_track')
