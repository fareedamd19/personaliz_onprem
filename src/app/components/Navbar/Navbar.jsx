    ...
    <nav className="w-full h-[65px] px-5 py-1 flex items-center justify-between bg-white shadow-md relative">
      ...
      {showWarningText && (
        <p
          ...
          className={`${styles.warningCont} w-max md:w-max p-2 bg-black bg-opacity-50 text-white text-base md:text-lg rounded-md font-serif absolute left-1/2 -translate-x-[50%] -bottom-4`}
        >
